...
class PetFriends:
    ...
    def post_api_pet(self, auth_key: json, name: str, animal_type: str,
    ...
    def delete_api_pet(self, auth_key: json, pet_id: str) -> json:
    ...
    def post_api_pets_set_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавляемом фото питомца по его ID и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленной информации"""
